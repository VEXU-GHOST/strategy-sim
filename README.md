...
Right now the project has the core simulation loop, a Pillow renderer that produces top-down GIF/PNG output, and a couple of placeholder agents (random movement and stand-still). Scoring, game-over conditions, and actual strategy (MCTS / RL) are not yet implemented.
